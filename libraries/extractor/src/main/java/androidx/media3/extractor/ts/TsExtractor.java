...
public final class TsExtractor implements Extractor {
  ...
  public static final int DEFAULT_TIMESTAMP_SEARCH_BYTES = 600 * TS_PACKET_SIZE * 16;
  ...
  public static final int TS_STREAM_TYPE_SPLICE_INFO_OR_BLU_RAY_DTS_HD_MA = 0x86;
  ...
  public static final int TS_STREAM_TYPE_DTS_HD_2 = 0x88; // As per ATSC Code Point Registry
  public static final int TS_STREAM_TYPE_DTS_UHD = 0x8B;

  // Stream types that aren't defined by the MPEG-2 TS specification.
  public static final int TS_STREAM_TYPE_DC2_H262_OR_BLU_RAY_PCM_AUDIO = 0x80;
  ...
  public TsExtractor(
    ...
    this.timestampSearchBytes = timestampSearchBytes % packetSize == 0 ? timestampSearchBytes
        : timestampSearchBytes / TS_PACKET_SIZE * packetSize;
  ...
  public @ReadResult int read(ExtractorInput input, PositionHolder seekPosition)
    ...
    if (payloadExists) {
      payloadReader = tsPayloadReaders.get(pid);
      if (payloadReader == null) {
        payloadReader = new SectionReader(new PmtReader(pid));
        tsPayloadReaders.put(pid, payloadReader);
      }
    } else {
      tsPacketBuffer.setPosition(endOfPacket);
      return RESULT_CONTINUE;
